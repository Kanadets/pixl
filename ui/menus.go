...
func BuildNewMenu(app *AppInit) *fyne.MenuItem {
	return fyne.NewMenuItem("New", func() {
		...
		widthFromEntry := widget.NewFormItem("Width", widthEntry)
		heightFromEntry := widget.NewFormItem("Height", heightEntry)

		formItems := []*widget.FormItem{widthFromEntry, heightFromEntry}
